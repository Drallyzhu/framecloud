package com.framecloud.auth.controller;

import com.framecloud.auth.query.OAuth2AccessTokenQuery;
import com.framecloud.common.base.constants.CommonConstants;
...
public class AuthController {
    ...
    public ApiResult getTokenList(OAuth2AccessTokenQuery oAuth2AccessTokenQuery) {
        ...
        oAuth2AccessTokenQuery.setRecords((List)redisTemplate.opsForList().range(CommonConstants.FRAME_CLOUD_REDIS_LIST_LEY, oAuth2AccessTokenQuery.getStart(), oAuth2AccessTokenQuery.getEnd()));
        List<OAuth2AccessToken> all = (List)redisTemplate.opsForList().range(CommonConstants.FRAME_CLOUD_REDIS_LIST_LEY, 0, -1);
        if(all != null){
