...
public class SysRoleController {
    ...
    @SysLog(serviceId = FrameCloudServiceNameConstants.FRAME_CLOUD_USER_SERVICE, moduleName = MODULE_NAME, actionName = "添加角色")
    ...
    @SysLog(serviceId = FrameCloudServiceNameConstants.FRAME_CLOUD_USER_SERVICE, moduleName = MODULE_NAME, actionName = "修改角色")
    ...
    @SysLog(serviceId = FrameCloudServiceNameConstants.FRAME_CLOUD_USER_SERVICE, moduleName = MODULE_NAME, actionName = "删除角色")
    ...
    @SysLog(serviceId = FrameCloudServiceNameConstants.FRAME_CLOUD_USER_SERVICE, moduleName = MODULE_NAME, actionName = "查询角色信息以及相关联的资源信息")
    ...
    @SysLog(serviceId = FrameCloudServiceNameConstants.FRAME_CLOUD_USER_SERVICE, moduleName = MODULE_NAME, actionName = "角色信息分页查询")
